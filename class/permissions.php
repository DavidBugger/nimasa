    ...
    public function permission_list($data)
    {
        ...
        $columner = array(
            ...
            array('db' => 'id', 'dt' => 9, 'formatter' => function ($d, $row) {
                return "<a title='Edit Permissions' href=\"javascript:void(0)\" onclick=\"myLoadModal('setup/permission_setup.php?op=edit&id=$d','modal_div')\"><i  class='btn btn-primary fa fa-pencil'></i></a>
                    ";
            }),
