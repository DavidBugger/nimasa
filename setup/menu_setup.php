    ...
    <form id="form1" onsubmit="return false" autocomplete="off">
        ...
        <div class="row">
                    ...
                    <select name="parent_id" class="form-select mb-3">
                        ...
                        if ($p['response_code'] == "0") {
                            foreach ($p['data'] as $key) {
                                $selected = (is_array($menu) && isset($menu[0]['parent_id']) && $key[0] == $menu[0]['parent_id']) ? "selected" : "";
                        ?>
            ...
            <div class="col-sm-6 py-2">
                ...
                <select name="icon" onchange="display_icon(this.value)" id="icon" class="form-select mb-3">
