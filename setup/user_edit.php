...
$sql_pastor = "SELECT user_name,firstname,lastname FROM userdata WHERE role_id = '003'";
...
if (isset($_REQUEST['op']) && $_REQUEST['op'] == 'edit') {
    ...
    $user      = $dbobject->db_query("SELECT * FROM userdata WHERE user_name='$user_name' LIMIT 1");
    $operation = 'edit';
} else {
    $operation = 'new';
}
